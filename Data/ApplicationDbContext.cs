...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options)
{
    ...
    public void ConfigureProductosModel(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Productos>().HasData(
            ...
            new Productos { Nombre = "Aretes de Perla", Cantidad = 50, Precio = 2800, ITBIS = 504.0f, ProductoId = 4, TipoId = 1, Disponible = true, Descripcion = "Aretes con perlas naturales y cierre de oro.", ImagenUrl = "/Imagen/aretes_perla.jpg" },
            new Productos { Nombre = "Anillo de Compromiso", Cantidad = 50, Precio = 9500, ITBIS = 1710.0f, ProductoId = 5, TipoId = 1, Disponible = true, Descripcion = "Anillo de oro blanco con diamante central talla brillante.", ImagenUrl = "/Imagen/anillo_compromiso.jpg" },
            ...
            new Productos { Nombre = "Broche Floral", Cantidad = 50, Precio = 1800, ITBIS = 324.0f, ProductoId = 7, TipoId = 1, Disponible = true, Descripcion = "Broche en forma de flor con incrustaciones de cristal.", ImagenUrl = "/Imagen/broche_floral.jpg" },
            new Productos { Nombre = "Pendientes de Oro", Cantidad = 50, Precio = 3500, ITBIS = 630.0f, ProductoId = 8, TipoId = 1, Disponible = true, Descripcion = "Pendientes de oro amarillo con diseño clásico.", ImagenUrl = "/Imagen/pendientes_oro.jpg" },
            new Productos { Nombre = "Anillo con Rubí", Cantidad = 50, Precio = 6800, ITBIS = 1224.0f, ProductoId = 9, TipoId = 1, Disponible = true, Descripcion = "Anillo de oro con rubí natural tallado.", ImagenUrl = "/Imagen/anillo_rubi.jpg" },
            new Productos { Nombre = "Collar de Diamantes", Cantidad = 50, Precio = 15000, ITBIS = 2700.0f, ProductoId = 10, TipoId = 1, Disponible = true, Descripcion = "Collar de oro blanco con diamantes de alta calidad.", ImagenUrl = "/Imagen/collar_diamantes.jpg" },

            // Relojes
            new Productos { Nombre = "Reloj Clásico de Acero", Cantidad = 50, Precio = 5200, ITBIS = 936.0f, ProductoId = 14, TipoId = 2, Disponible = true, Descripcion = "Reloj de acero inoxidable con correa metálica y esfera minimalista.", ImagenUrl = "/Imagen/reloj_acero.jpg" },
            new Productos { Nombre = "Reloj Automático de Lujo", Cantidad = 50, Precio = 15800, ITBIS = 2844.0f, ProductoId = 15, TipoId = 2, Disponible = true, Descripcion = "Reloj automático con caja de oro y correa de cuero genuino.", ImagenUrl = "/Imagen/reloj_lujo.jpg" }
