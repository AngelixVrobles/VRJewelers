...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options)
{
    ...
    public void ConfigureProductosModel(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Productos>().HasData(
            ...
            new Productos { NombreProducto = "Aretes de Perla", Precio = 2800, ProductoId = 4, TipoProducto = "ARETE", Descripcion = "Aretes con perlas naturales y cierre de oro.", ImagenUrl = "https://www.costco.com.mx/medias/sys_master/products/hbc/h21/79532149899294.webp" },
            ...
            new Productos { NombreProducto = "Gargantilla de Zafiro", Precio = 8700, ProductoId = 6, TipoProducto = "COLLAR", Descripcion = "Gargantilla de oro rosa con piedra de zafiro azul.", ImagenUrl = "https://www.salvadormunozjoyero.com/wp-content/uploads/2023/02/gargantilla-zafiro-diamantes.jpg" },
            ...
            new Productos { NombreProducto = "Collar de Diamantes", Precio = 15000, ProductoId = 10, TipoProducto = "COLLAR", Descripcion = "Collar de oro blanco con diamantes de alta calidad.", ImagenUrl = "https://cdn.forbes.com.mx/2019/01/unnamed-1-623x360.jpg" },
            ...
            new Productos { NombreProducto = "Reloj Automático de Lujo", Precio = 15800, ProductoId = 12, TipoProducto = "RELOJ", Descripcion = "Reloj automático con caja de oro y correa de cuero genuino.", ImagenUrl = "https://m.media-amazon.com/images/I/71cHycfubnL._AC_SY695_.jpg" }
        );
    }
}
